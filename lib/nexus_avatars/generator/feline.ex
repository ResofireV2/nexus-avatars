defmodule NexusAvatars.Generator.Feline do
  @moduledoc """
  Feline avatar style — placeholder pending full implementation.
  Renders a simple geometric placeholder in the teal/green color family.
  """
  ...
  def render(username) do
    ...
    # Teal family: background dark, two concentric circles
    bg  = shade_hex(0x04, 0x2f, 0x2e, shade)
    mid = shade_hex(0x0d, 0x94, 0x88, shade)
    hi  = shade_hex(0x99, 0xf6, 0xe4, shade)
